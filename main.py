...
def get_favorite_restaurant_count():
    #TODO: pagination must be considerated, not doing right now
    ...
    return favorites_section.get_attribute("childElementCount")
...
def main():
    ...
    print("Favorite Restaurant Count: " + favorite_count)
